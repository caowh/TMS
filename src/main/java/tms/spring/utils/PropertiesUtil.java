...
public class PropertiesUtil {
    ...
    public static void main(String[] args) {
        /*String path = "/threshold.properties";
        String v = PropertiesUtil.getValue(path, "threshold");
        _log.info("value0 = " + v);
        ...
        String path = "src/main/resources/threshold.properties";
        PropertiesUtil.updateValue(path,"threshold","5");
    }
}