...
<head lang="en">
    ...
    <style>
        ...
        .main-text h1 {
            ...
            margin:0;
            padding:0;
            animation:rt 5s linear 0s infinite alternate;
        }
        .main-text-a{
            height:32px;
            margin-left:auto;
        ...
        .mound:after {
            ...
            box-shadow: -56px 12px 0 1px #dd4040, -126px 6px 0 2px #dd4040, -196px 24px 0 3px #dd4040,56px 12px 0 1px #dd4040, 126px 36px 0 2px #dd4040, 196px 60px 0 3px #dd4040;
        }

        .mound_text {
            animation:bound 2s linear 0s infinite alternate;
        }
        @keyframes bound {
            0%,100%{
...
<div class="content">
    ...
    <div class="main-text">
        <h1>HTTP BUZY<br>服务器正忙，请稍后访问！</h1>
        <div class="main-text-a"><a href="/login.jsp">< 返回首页</a></div>
    </div>
    <div class="ground">
        <div class="mound">
