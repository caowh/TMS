...
(function (){
    ...
    function getverificat(){
        var url="http://localhost:8080/TMS/before/getLoginValidateJpg.do?math="
            ...
            if(!mytest.usernameTest(myName)){
                ...
                if(myName){
                    ...
                    $.ajax({
                        ...
                        url: "http://localhost:8080/TMS/before/checkUserName.do",
            ...
            if(!mytest.emailTest(value)){
                ...
                if(value){
                    $.ajax({
                        type: "post",
                        contentType: "application/json; charset=utf-8",
                        url: "http://localhost:8080/TMS/before/sendEmailToGetValidateCode.do",
    ...
    $("#regTj").click(function(){
        ...
        $.ajax({
            type: "post",
            contentType: "application/json; charset=utf-8",
            url: "http://localhost:8080/TMS/before/register.do",
    ...
    $("#logTj").click(function(){
        ...
        $.ajax({
            type: "post",
            contentType: "application/json; charset=utf-8",
            url: "http://localhost:8080/TMS/before/login.do",
            data: JSON.stringify(sendData),
            dataType: "json",
            success: function(res){
